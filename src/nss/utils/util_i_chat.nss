...
sqlquery chat_PrepareQuery(string s)
{
    return SqlPrepareQueryCampaign("TEST_CHAT", s);
}
...
/// r = regex to find the desired arguments
json chat_ParseArguments(string cmd, string r)
{
    return RegExpIterate(r, cmd);
}
